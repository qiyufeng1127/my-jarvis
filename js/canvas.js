...
const Canvas = {
        ...
        document.querySelectorAll('.draggable-component').forEach(function(comp) {
            ...
            if (picker) {
                picker.addEventListener('input', function(e) {
                    ...
                    // 如果是智能对话组件，更新气泡颜色
                    if (comp.id === 'smartInput' && typeof App !== 'undefined') {
    ...
    setComponentBackground(comp, color) {
        ...
        allElements.forEach(function(el) {
            ...
            // 事件标题
            if (classList.includes('event-title')) {
                el.style.setProperty('color', textColor, 'important');
            }
            
            // 事件时间
            if (classList.includes('event-time')) {
                el.style.setProperty('color', textColorMuted, 'important');
            }
            
            // 事件地点
            if (classList.includes('event-location')) {
                el.style.setProperty('color', textColorLight, 'important');
            }
            
            // 事件标签
            if (classList.includes('event-tag')) {
                el.style.setProperty('background', buttonBg, 'important');
                el.style.setProperty('color', textColorMuted, 'important');
            }
            
            // 事件详情
            if (classList.includes('event-details')) {
                el.style.setProperty('border-color', borderColor, 'important');
            }
            
            // 事件详情标签
            if (classList.includes('event-detail-label')) {
                el.style.setProperty('color', textColorLight, 'important');
            }
            
            // 事件详情值
            if (classList.includes('event-detail-value')) {
                el.style.setProperty('color', textColor, 'important');
            }
            
            // 展开按钮
            if (classList.includes('event-expand-btn')) {
                el.style.setProperty('color', textColorLight, 'important');
            }
