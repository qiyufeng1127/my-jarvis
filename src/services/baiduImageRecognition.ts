  ...
  async smartVerifyImage(
    ...
    try {
      ...
      const synonyms: Record<string, string[]> = {
        // 洗澡/淋浴相关（新增）
        '淋浴间': ['淋浴', '浴室', '卫生间', '洗手间', '厕所', '花洒', '淋浴花洒', '喷头', '浴室镜', '镜子', '洗澡', '沐浴', '浴缸', '浴帘', '地漏', '瓷砖', '墙砖', '地砖', '水龙头', '龙头', '洗浴', '盥洗室'],
        '淋浴': ['淋浴间', '浴室', '卫生间', '花洒', '淋浴花洒', '喷头', '洗澡', '沐浴', '浴室镜'],
        '热水': ['水', '水流', '水龙头', '龙头', '花洒', '淋浴', '洗澡', '沐浴', '温水', '热', '蒸汽', '雾气'],
        '沐浴露': ['洗发水', '护发素', '香皂', '肥皂', '洗手液', '沐浴', '洗澡', '清洁', '洗浴用品', '瓶子', '塑料瓶', '洗护用品', '日用品'],
        '准备洗澡': ['淋浴', '浴室', '卫生间', '花洒', '洗澡', '沐浴', '淋浴间', '浴室镜', '镜子', '毛巾', '浴巾'],
